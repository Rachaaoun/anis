 ...
 * @author Lenovo
 */
public class ModifierCoupon extends BaseForm {
    
    Form current;
    public ModifierCoupon(Resources res , Coupon h) {
        ...
        setTitle("Modif Coupon");
        getContentPane().setScrollVisible(false);
        
        
        super.addSideMenu(res);
        
        TextField code = new TextField(h.getCode(), "Code" , 20 , TextField.ANY);
        TextField pourcentageReduction = new TextField(h.getPourcentageReduction(), "Pourcentage Reduction " , 20 , TextField.ANY);
       ...
       Add.addPointerPressedListener(l ->   { 
           ...
           h.setPourcentageReduction(pourcentageReduction.getText());
     ...
     //  r.setDateexpiration(r.getDateexpiration());
       ...
       if(CouponService.getInstance().modifierCoupon(h)) { // if true
